...
export const regulations: Regulation[] = [
  ...
  },
  {
    ...
    titleEn: 'Time Limit',
    contentEs: 'El tiempo límite total es de 1 hora desde la salida. Los atletas que no crucen la línea de meta en este tiempo serán descalificados.',
    contentEn: 'Total time limit is 4 hour from start. Athletes not crossing finish line within this time will be disqualified.',
    category: 'rules',
  },
  {
    id: 'safety-2',
