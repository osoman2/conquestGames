...
- Circuito (orden correcto): Run 475 m → KB Swings 30 reps (2 manos) → Run 475 m → Caminata Granjero x2 rectas → Run 475 m → Burpees x2 rectas → Trote 475 m a la meta. Total: 1.9 km running + 3 estaciones funcionales.
...
- Circuit (correct order): Run 475 m → KB Swings 30 reps (2-hand) → Run 475 m → Farmer Carry x2 straights → Run 475 m → Burpees x2 straights → Jog 475 m to finish. Total: 1.9 km + 3 functional stations.
